...
filePath = 'VectorDataset/tamperedVectorData.csv'
...
filePath = 'VectorDataset/labelData.csv'
labelsDf = pd.read_csv(filePath, header=None, names=['label'])
labelsList = labelsDf.values
# CHANGED: Slice from 5 instead of 6 to match predictions length
labelsList = labelsList[5:]

numFeatures = tamperedDf.shape[1]

# Create windows
# CHANGED: input_width=5 to match prediction index 4
